...
const Messengers = () => {
  const messengers = [
    { name: "Facebook", icon: "/messengers/facebook.png" },
    { name: "WhatsApp", icon: "/messengers/whatsapp.png" },
    { name: "Telegram", icon: "/messengers/telegram.png" },
  ];

  return (
    <section id="messengers" className="relative px-6 md:px-16 py-20 md:py-32 max-w-7xl mx-auto">
      <motion.div
