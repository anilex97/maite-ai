    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16">
        {avatars.map((avatar, index) => (
          <motion.div
            key={avatar.name}
            onClick={() => handlePick(avatar.name)}
          ...
          >
            <div
              className={`relative w-64 h-64 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-white/50 shadow-2xl`}
            >
              <div
